...
import RtaTableFiltersResult from '../rta-table-filters-result';
...
export default function RtaListView() {
  ...
  const handleViewRow = useCallback(
    () => {
      router.push(paths.dashboard.rta.view);
    },
    [router]
  );
  //  const handleViewRow = useCallback(
  //   (id) => {
  //     router.push(paths.dashboard.rta.details(id));
  //   },
  //   [router]
  // );
    ...
    <>
      <Container maxWidth={settings.themeStretch ? false : 'lg'}>
        ...
        <Card>
          ...
          <RtaTableToolbar filters={filters} onFilters={handleFilters} />

          {canReset && (
            <RtaTableFiltersResult
              filters={filters}
