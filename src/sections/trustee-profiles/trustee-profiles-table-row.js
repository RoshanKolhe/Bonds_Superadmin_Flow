...
export default function TrusteeProfilesTableRow({
  row,
  selected,
  onEditRow,
  onViewRow,
  ...
  const { legalEntityName, CIN, GSTIN, kycApplications, createdAt } = row;
    ...
    <>
      <TableRow hover selected={selected}>
        <TableCell sx={{ display: 'flex', alignItems: 'center' }}>
          <Avatar alt={legalEntityName} sx={{ mr: 2 }} />

          <ListItemText
            primary={legalEntityName}
...
TrusteeProfilesTableRow.propTypes = {
