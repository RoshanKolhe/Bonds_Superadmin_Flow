...
import AppointedValuerTableToolbar from '../appointed-valuer-table-toolbar';
    ...
    <>
      <Container maxWidth={settings.themeStretch ? false : 'lg'}>
        ...
        <Card>
          ...
          <AppointedValuerTableToolbar filters={filters} onFilters={handleFilters} />

          {canReset && (
            <AppointedValuerTableFiltersResult
              filters={filters}
...
AppointedValuerListView.propTypes = {
  currentValuer: PropTypes.arrayOf(PropTypes.object)
